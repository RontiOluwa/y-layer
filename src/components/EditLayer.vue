  ...
  <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
    ...
    <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          ...
          <div class="mt-3 text-center w-full sm:text-left">
            ...
            <div class="mt-2">
              <p class="text-sm text-gray-500">
                Enter new name of layer and click submit
              </p>
            </div>
            <label class="block mt-4">
              <input id="newlayer_name" class="w-full p-2 border rounded-md border-gray-400 border-opacity-50 border-current" placeholder="Layer 1">
            </label>
          </div>
        </div>
      </div>
      <div class="bg-white px-4 py-3 sm:px-6 sm:flex">
        ...
        <button type="button" @click="editlayers()" class="w-full float-right inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-600 text-base font-medium text-white hover:blue-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm">
          Submit
        </button>
